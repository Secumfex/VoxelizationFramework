...
class PrintVoxelGridInfoListener : public Listener
{
public:
	PrintVoxelGridInfoListener(VoxelGridGPU* voxelgridGPU);
	VoxelGridGPU* p_voxelgridGPU;
	virtual void call();
};
...
public:
	...
	// get info printer
	Listener* getPrintVoxelGridInfoListener();
};
