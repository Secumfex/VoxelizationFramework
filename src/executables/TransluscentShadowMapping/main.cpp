...
//			DEBUGLOG->outdent();
		...
		DEBUGLOG->indent();
			...
			SliceMap::SliceMapRenderPass* voxelizeWithTextureAtlas = SliceMap::getSliceMapRenderPass( 5.0f, 5.0f, 5.0f, voxelGridResolution, voxelGridResolution, 4, SliceMap::BITMASK_SINGLETARGET, vertexShader);
